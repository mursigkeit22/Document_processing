function callBleuScriptAWS(colReferenceLetter, colHypothesisLetter, cell) {
  ...
  cardSection.addWidget(CardService.newTextParagraph().setText(result.getContentText()));
